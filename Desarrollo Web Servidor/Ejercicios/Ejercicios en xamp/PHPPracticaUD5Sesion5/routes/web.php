...
Route::get('/microblogging',  [PostController::class,'index'])->name('microblogging.index');
Route::post('/microblogging',  [PostController::class,'store'])->name('microblogging.store');
